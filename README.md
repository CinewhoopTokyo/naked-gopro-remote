...
**剥きプロ（naked GoPro）** に BLE で繋ぎ、飛ばす前に確かめたいことを手元に出す小さなリモコン。
...
剥きプロでも前面の小さな液晶は残るが、機体に組めばプロップの向こう側でこちらを向いていない。
**録画が始まったのか／SD が入っているのか／動画モードなのか**が
...
| 電源 | **1S LiPo 502025**（5.0 × 20 × 25mm・約250mAh）。JST PH 2.0。USB-C で充電。**一次電池は不可** |
| 電源操作 | 方向スイッチの中央を 2秒長押しで電源オフ、**REC で復帰**。30分無操作でも自動オフ（録画中を除く） |
| 連続動作 | 録画中 約12.5時間（★見積り・実機未測定） |
